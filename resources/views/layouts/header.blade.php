<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="" class="brand-link text-center font-weight-bolder">

      <span class="brand-text font-weight-light
      ">
        R.N. Pally FP School</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item {{ Request::is('admin/admin/list') ? 'menu-open' : '' }}">
            ...
            <li class="nav-item {{ Request::is('admin/assign_subject/list') ? 'menu-open' : '' }}">
                <a href="{{ url('admin/assign_subject/list')}}" class="nav-link {{ Request::is('admin/assign_subject/list') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p>
                        Assign Subject
                    </p>
